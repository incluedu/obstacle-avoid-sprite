...
import net.lustenauer.obstacleavoid.entity.Background;
import net.lustenauer.obstacleavoid.entity.Obstacle;
import net.lustenauer.obstacleavoid.entity.Player;
